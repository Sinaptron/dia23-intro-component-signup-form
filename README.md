...
<p>Intro Component With Sign-Up Form, Este proyecto es parte del desafío #100daysofprojects promovido por:</p> 
...
- Visualizar un mensaje de error cuando:

1. Cualquier campo de "entrada" esté vacío. El mensaje de este error debería decir "[Nombre del campo] no puede estar vacío".

2. La dirección de correo electrónico no tiene el formato correcto. El mensaje de este error debería decir "Parece que este no es un correo electrónico".

### _Importante:_
- Agregar icono favicon al proyecto.
- Renombrar URL fácil de recordar (ej. Intro Component With Sign-Up Form ).
- Agregar título al proyecto (ej. Intro Component With Sign-Up Form - Frontend Club).
...
`>>>` : [Opcion 01](https://frontend-club.hashnode.dev/intro-component-with-sign-up-form)<br>
